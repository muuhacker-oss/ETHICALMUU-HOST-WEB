...
<head>
    ...
    <title>ETHICALMUU FREE WEB HOSTING</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>🌐 ETHICALMUU FREE WEB HOSTING</h1>
...
<body>
    <div class="container">
        ...
        <footer>
            <p style="font-size: 0.9rem;">DEVELOPED BY <strong style="color: #4cc9f0;">ETHICALMUU-TECH</strong></p>
        </footer>
    </div>
